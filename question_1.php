<?php
// Written by Stephen Wang 
// Last edited date: 8/12/2017
...
<table>
	...
	<?php
	/**
	* User interface in html format 
	* This function asks user to input the customer ID, first name, last name and occupation name
	*/
